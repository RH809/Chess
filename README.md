# Chess
This is a chess application that supports playing on one or two devices. It includes features such as annotations, undoing moves, saving and loading to/from files, and multiplayer chat.
